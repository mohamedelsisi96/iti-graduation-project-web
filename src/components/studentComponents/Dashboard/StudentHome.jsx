...
function StudentHome() {
    return (
        <>
            ...
            <div className="container text-blue-700 text-5xl mt-5 text-center">
                Hello, here is the dashbard of students. You should use the sidebar to show your Calender, Table or Courses
            </div>
        </>
    );
}
